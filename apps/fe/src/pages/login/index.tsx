      ...
      <div className="w-[400px] mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="mt-4 space-y-4">
          <div>
            ...
            <input type="email" id="email" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          </div>
          <div>
